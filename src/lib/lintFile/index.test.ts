...
describe(`lintFile`, () => {
	it(`should return null for valid BEM file`, async () => {
		let result = await lintFile(new URL(`../lintContent/fixtures/valid.html`, import.meta.url).pathname)

		expect(result).toBeNull()
	})

	it(`should return result with warnings for invalid BEM file`, async () => {
		let result = await lintFile(new URL(`../lintContent/fixtures/error-complex.html`, import.meta.url).pathname)
	...
	it(`should include correct filePath in result`, async () => {
		let filePath = new URL(`../lintContent/fixtures/error-complex.html`, import.meta.url).pathname
	...
	it(`should return correct warning count for element error file`, async () => {
		let result = await lintFile(new URL(`../lintContent/fixtures/error-in-element-without-block.html`, import.meta.url).pathname)
	...
	it(`should return correct warning count for modifier error file`, async () => {
		let result = await lintFile(new URL(`../lintContent/fixtures/error-in-modifiers.html`, import.meta.url).pathname)
	...
	it(`should return correct warning count for separator error file`, async () => {
		let result = await lintFile(new URL(`../lintContent/fixtures/error-in-separators.html`, import.meta.url).pathname)
